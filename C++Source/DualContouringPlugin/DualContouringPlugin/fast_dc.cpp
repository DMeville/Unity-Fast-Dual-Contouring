...
static void FindActiveVoxels(
	...
	int worldX, int worldY, int worldZ, const int voxelGridSize)
{
...
MeshBuffer* GenerateMesh(int x, int y, int z, int cellSize, float& debugVal)
{
	VoxelIDSet activeVoxels;
	EdgeInfoMap activeEdges;

	FindActiveVoxels(activeVoxels, activeEdges, x, y, z, cellSize);
	...
	VoxelIndexMap vertexIndices;
	GenerateVertexData(activeVoxels, activeEdges, vertexIndices, buffer, debugVal);
